...
// Add our tool, and set it's mode
    ...
    const PanTouchDragTool = cornerstoneTools.PanTouchDragTool;
    ...
    cornerstoneTools.addTool(PanTouchDragTool);

    // Set tool modes
    cornerstoneTools.setToolActive("Pan", { mouseButtonMask: 2}); // Middle
    ...
    cornerstoneTools.setToolActive(('PanTouchDrag',{}));
